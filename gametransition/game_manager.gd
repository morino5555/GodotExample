#
# https://www.youtube.com/watch?v=EBeyUKTapMA
#
...
func _process(delta: float) -> void:
	if Input.is_action_just_pressed("ui_up"):
		GameManager.change_scene("res://level_1.tscn", TransitionType.ZoomOut)
	if Input.is_action_just_pressed("ui_right"):
		GameManager.change_scene("res://level_2.tscn", TransitionType.SwipeRight)
	if Input.is_action_just_pressed("ui_down"):
		GameManager.change_scene("res://level_3.tscn", TransitionType.FallDown)
